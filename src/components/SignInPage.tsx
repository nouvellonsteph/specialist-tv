        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="space-y-4">
            {providers && Object.values(providers).map((provider) => {
              ...
              const isCloudflareProvider = provider.id === 'cloudflare-access';
                      ...
                      <div className="flex items-center">
                        ...
                        {isCloudflareProvider && (
                          <svg className="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M13.04 13.77a.76.76 0 0 1-.04.29c-.05.15-.17.25-.33.25H8.5c-.16 0-.28-.1-.33-.25a.76.76 0 0 1-.04-.29c0-.1.02-.2.06-.29.04-.09.1-.17.18-.23l2.13-1.59c.08-.06.18-.09.28-.09s.2.03.28.09l2.13 1.59c.08.06.14.14.18.23.04.09.06.19.06.29z"/>
                          </svg>
                        )}
